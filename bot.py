...
2 дорослих - цілий день працюють ведуть активний образ життя, дитина ходить у садочок(обід у садочку)
...
2. Харчування має бути різноманітним:
   ...
   - Обід, Вечеря, Сніданок має бути ситним
   ...
   - Їжі має бути достаньо але не надлишок
   - одразу порції зазначай на трьох осіб
   - додавай корткі рецепти до страв
3. Склади список продуктів до купівлі, яких НЕМАЄ вдома. Використовуй якісні, доступні і сезонні продукти
4. Вкажи реальні рознічні ціни на ринку/в супермаркетах Києва (в грн). Краще для кожного продукту додай вартість +5%
